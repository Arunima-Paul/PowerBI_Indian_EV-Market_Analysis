...
![EV_3](https://github.com/user-attachments/assets/f5e98e3d-42ea-4c79-9f72-6902d31a4a46)

**The revenue data already shows strong growth trajectories:**
**For 4-Wheelers:**
•	Revenue grew from ₹27866 million in 2022 to ₹130352 million in 2024.
•	This represents an impressive 367.79% growth over this period.
•	The growth from 2023 to 2024 alone was 83.08%.

**For 2-Wheelers:**
•	Revenue grew from ₹21,469 million in 2022 to ₹79,279 million in 2024.
•	This shows a 269.28% growth over this period.
•	Growth from 2023 to 2024 was more modest at 28.13%.

**When we examine individual manufacturer performance in the 4-Wheeler segment:**
•	BMW India shows exceptional performance with 15300.00% revenue growth from 2022-2024 and 278.25% growth from 2023-2024.
•	BYD India demonstrates remarkable growth at 4342.42% from 2022-2024, though with a more modest 59.35% growth in the most recent year.
•	Other strong performers include: 
o	Hyundai Motor: 1163.64% (2022-2024), 141.32% (2023-2024).
o	Volvo Auto India: 1872% (2022-2024), 337.14% (2023-2024).

In the 2-Wheeler segment, we see varied performance:
•	Top performing brands include: 
o	OLA Electric with 2,139.35% growth.
o	BAJAJ with 1,385.73% growth showing a strong comeback.
o	TVS with 1,755.87% growth.

•	Some manufacturers show negative or inconsistent growth: 
o	BEING, JITENDRA, PURE EV have -100% growth rates, indicating possible market exits.
o	HERO ELECTRIC is declining with -82.80% (2022-2024) and -86.57% (2023-2024.

**11. At the state level, our projections for 2030 show tremendous growth potential:**
•	Maharashtra- already the current leader in total EV sales (197169 units in FY2024), is projected to maintain strong growth trajectory.
•	Kerala with its current 11.59% penetration and impressive 132.83% CAGR, is positioned to be among the top EV markets by 2030.
•	Uttar Pradesh is projected to reach 10.42 million EV sales by 2030, making it the another large potential market.
•	Karnataka follows with projected sales of 8.38 million units by 2030.
•	States showing remarkable current growth rates that will impact future projections include: 
o	Meghalaya (28.47% CAGR)
o	Goa (27.41% CAGR)
o	Karnataka (25.28% CAGR)
These projections reinforce the tremendous opportunity for AtliQ Motors in India, especially in key states and at strategic price points.

**12. What's Driving EV Adoption?**
**Why are consumers increasingly choosing EVs?** 
According to NITI Aayog data, the primary reasons include:
1.	**Lower running costs **– EVs are simply cheaper to operate than petrol or diesel vehicles
2.	**Low maintenance costs** – Fewer moving parts means less servicing
3.	**Zero tailpipe emissions** – Growing environmental consciousness
4.	**Ease of driving **– No gears and quieter operation

Government incentives are playing a crucial role too. 
The PM E-Drive scheme- launched in October2024 provides subsidies for various EV categories, 
including ₹5,000 per kilowatt-hour for two-wheelers (up to ₹10,900 in the first year).
Source-The Economics Times.
Source- NITI Ayog e-Amrit website https://e-amrit.niti.gov.in/state-level-policies

Source -https://www.godigit.com/motor-insurance/ev-guides/state-wise-ev-subsidies

States offering the best incentives include Gujarat, Maharashtra, Meghalaya, Karnataka, Andhra Pradesh, Telangana, Tamil Nadu and Kerala.

Our data strongly suggests that states with higher subsidies show higher adoption rates—
a direct correlation we can leverage in our market entry strategy.

**13. Charging Infrastructure: Another Critical Enabler**
Another key factor influencing adoption is the availability of charging stations. 
From the Insights from Primary Data we can assess that
•	States with higher urbanization like Maharashtra, Karnataka, Kerala, Goa, Delhi show stronger EV adoption.
•	The map visualization shows clustering of higher penetration in metropolitan regions.
•	Year-over-year growth patterns suggest infrastructure expansion is happening alongside adoption.
•	It can be expected Positive correlation between charging stations and EV penetration 
(but not perfectly linear because urban density matters too). 
**More chargers = higher confidence = more EV sales.**

Source:
•	Ministry of Power EV Public Charging Data
 https://powermin.gov.in/en/content/electric-vehicle


**14.Strategic Recommendations**-
****a). Recommendation 1: Phased Market Entry Strategy**-**
•	Begin with the top 5 states by penetration: Goa, Kerala, Karnataka, Maharashtra and Delhi.
•	Focus initially on premium 4-wheeler EVs where competition from local manufacturers is lower.
•	Expand to mass-market segments in Phase 2 after establishing our brand presence.

**Recommendation 2: Consider the Two-Wheeler Segment-**
...
o	Public fast charging tie-ups.

**Strategic Bonus Recommendation**
•	Launch a low-cost, urban-friendly EV first in the ₹6-10 lakh range
•	Build our own charging network partnerships (similar to Tata Power's approach).

**Manufacturing Location**
For manufacturing base Gujarat stands out as the ideal location due to:
...
•	Fits the EV market demographic (young and aspirational),
•	Is highly trusted by Indian consumers,
•	Is known for fitness, which aligns with clean environment values.


**Conclusion**
1. To conclude, the Indian EV market presents significant opportunities for AtliQ Motors.
   While the overall penetration is still low at 3.61%, the growth trajectory is impressive with a CAGR of 13.56%.
